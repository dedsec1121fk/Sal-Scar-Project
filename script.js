const i18n = {
  en: {
    ...
    no_images: "No images. No logos. Just black & white — built for speed, clarity, and trust.",
    about_title: "About",
    ...
    contact_sub: "Tap the email to copy.",
    contact_h3: "Email",
  ...
  id: {
    ...
    kv_tools_k: "Keahlian",
    kv_tools_v: "Burp Suite · Postman · Nessus · Frida · Objection",
    no_images: "Tanpa gambar. Tanpa logo. Hanya hitam & putih — cepat, jelas, dan terpercaya.",
    about_title: "Tentang",
    ...
    about_p_2:
      "Saya menyusun laporan teknis yang detail dan menyampaikan temuan dengan jelas — agar tim bisa memprioritaskan perbaikan, memvalidasi remediation, dan mengurangi risiko.",
    approach_k: "PENDEKATAN",
    approach_v:
      "Dampak dunia nyata, langkah yang bisa direproduksi, dan severity berbasis bukti — setiap temuan berguna, bukan berisik.",
    ...
    contact_sub: "Ketuk email untuk menyalin.",
    contact_h3: "Email",
